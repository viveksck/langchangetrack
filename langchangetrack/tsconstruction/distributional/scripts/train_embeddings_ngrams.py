...
def run(filename, output_dir, file_prefix, window_size, embedding_type, embedding_size):
...
def main(args):
    ...
    run(filename, output_dir, file_prefix, window_size, embedding_type, embedding_size)
